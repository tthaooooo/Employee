...
if filtered.empty:
    ...
    # Không cần set width cố định, để use_container_width=True trong từng cột để tự giãn
    ...
    # Tạo 2 cột, bar chart chiếm 40%, area chart chiếm 60%
    col_bar, col_area = st.columns([4, 6])

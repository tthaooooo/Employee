...
if data.empty:
    ...
    # Kích thước biểu đồ tùy theo filter
    chart_width = 600 if show_filters else 900
    chart_height = 400
    ...
    fig_bar.update_layout(width=chart_width)
    ...
    fig_area.update_layout(width=chart_width)
    ...
    # Display charts side-by-side with flexible column widths
    if show_filters:
